...
def main(args):
	...
	#while num_iter < 4 and maxDelta >2: 
	  ...
	  #old_centroid is filled in for future reference
	  cfile = open("centroidinput.txt", "r")
	  #oldCentroid = cfile.readline()
	  oldCentroid = '79,27 28,25 77,72 22,16 13,60'
	  ...
	  if num_iter ==1:
		...
		currentCentroid = '78,28 25,87 77,72 21,14 17,58'
		
	  elif num_iter ==2:
		shutil.copyfile("centroidinput.txt", "centroidinput2.txt")
		currentCentroid = '78,28 24,90 77,72 20,13 20,58'
		oldCentroid = '78,28 25,87 77,72 21,14 17,58'
	  elif num_iter ==3:
		shutil.copyfile("centroidinput.txt", "centroidinput3.txt")
		oldCentroid = '78,28 24,90 77,72 20,13 20,58'
		currentCentroid = '78,28 23,89 77,72 20,13 21,57'
	  elif num_iter ==4:
		shutil.copyfile("centroidinput.txt", "centroidinput4.txt")
		currentCentroid = '78,28 22,88 77,72 20,13 22,55'
		oldCentroid = '78,28 23,89 77,72 20,13 21,57'
	  elif num_iter ==5:
		shutil.copyfile("centroidinput.txt", "centroidinput5.txt")
		oldCentroid = '78,28 22,88 77,72 20,13 22,55'
		currentCentroid = '79,27 22,88 77,72 20,11 24,52'
	  elif num_iter ==6:
		shutil.copyfile("centroidinput.txt", "centroidinput6.txt")
		oldCentroid = '79,27 22,88 77,72 20,11 24,52'
		currentCentroid = '79,27 22,87 78,73 20,11 26,51'
	  elif num_iter ==7:
